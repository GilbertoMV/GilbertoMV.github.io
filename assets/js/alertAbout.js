Swal.fire({
    title: '¡mi museo!',
    text: 'siempre te expreso la manera en la que mis ojos te ven, lo hermosa que eres, el brillo maravilloso que tienes y lo enamorado que estoy de cada parte de tí, nunca consigo que te veas con mis ojos, por ello aquí econtrarás una pestaña dedicada a lo maravillosa que eres.',
    iconHtml: '💘',
    iconColor:'#e7ded3',
    background:"#e7ded3",
...
$("#btn4").click(function(){
    Swal.fire({
        title: 'tu mirada',
        text: 'facilmente me pierdo en el cafe de tus ojos, esos tiernos, grandes y bellos ojos, esos que tanto cuidas con tu delineado que los hacen resaltar aún más, me perdería sin tus ojos, me guian a la paz, brillan tan hermoso cuando ves tu felicidad, mirarte a los ojos es mi cosa favorita en todo momento.',
        iconHtml: '<img src="./assets/imagenes/icon4.gif" width="150px" height="150px">',
        iconColor:'#e7ded3',
        background:"#e7ded3",
        showCloseButton:true,
        showConfirmButton:false,
...
$("#btn8").click(function(){
    Swal.fire({
        title: 'tu voz',
        text: 'lo admito, la voz que me ordena y me apetece obedecer, si tu voz me habla siempre voy a responder con amor, si tu voz me menciona honrado me sentiré, cuando el sonido de tu voz me dice "corazón" o "bebé", es como si los angeles me llamaran, tu voz es la música que no quiero pausar y disfruto sin igual, amor.',
        iconHtml: '<img src="./assets/imagenes/icon8.gif" width="150px" height="150px">',
        iconColor:'#e7ded3',
        background:"#e7ded3",
        showCloseButton:true,
        showConfirmButton:false,
...
$("#btn10").click(function(){
    Swal.fire({
        title: 'tu calor',
        text: 'nada mejor que estar pegadito a ti, sabes lo mucho que disfruto estar contigo, sentirte cerca me da paz, sentir tu corazón latir junto al mio en un abrazo es una manera tierna de sentir el amor que nos tenemos, dame un abrazo cuando leas esto por favor, mi vida!',
        iconHtml: '<img src="./assets/imagenes/icon10.gif" width="150px" height="150px">',
        iconColor:'#e7ded3',
        background:"#e7ded3",
        showCloseButton:true,
        showConfirmButton:false,
...
$("#btn14").click(function(){
    Swal.fire({
        title: 'tu cabello',
        text: 'me encanta acomodarlo detrás de tu pequeña orejita, aprovechar para acariciar ambas cosas a la vez, me encanta tu cabello, su color, su textura, su brillo, su largo, todo es maravilloso, da igual la manera en la que decidas peinarlo, o si decides no hacerlo, siempre luce maravilloso...',
        iconHtml: '<img src="./assets/imagenes/icon14.gif" width="150px" height="150px">',
        iconColor:'#e7ded3',
        background:"#e7ded3",
        showCloseButton:true,
        showConfirmButton:false,
...
$("#btn16").click(function(){
    Swal.fire({
        title: 'cariño',
        text: 'Ojalá te amaras tanto como amo cada parte de tu existencia, pero quiero que sepas algo, los años seguiran pasando, nuestros cuerpos seguiran cambiando, pero hay algo que no cambiará y es la manera en la que voy a amar cada parte de ti, nuestros pensamientos cambiaran, lo que creemos quizá no sea lo que mañana creamos, pero quiero estar ahí y cambiar contigo, siempre seguiré amando cada aspecto de ti así como tu lo haces de mí, no es el final de mi museo, mis ojos te toman miles de fotos cada que nos vemos así que habrá más exhibiciones del arte llamado "Esmemonita"',
        iconHtml: '<img src="./assets/imagenes/icon16.gif" width="150px" height="150px">',
        iconColor:'#e7ded3',
        background:"#e7ded3",
        showCloseButton:true,
        showConfirmButton:false,
